...
/datum/antagonist/clockcultist
	...
	welcome_text = "You have a clockwork slab in your possession; one that will help you start the cult on this station. Use it well and remember - there are others."
	...
	var/conversion_blurb = "You catch a glimpse of the Celestial Derelict, where Ratvar, the Clockwork Justicar rusts eternally. \
	Ratvar has formed a covenant of mortals, with you as one of its newest recruits. \
	As one of the Justiciar's servants, you are to free your master from His prison."
	faction = "clockcult"
